#!/bin/bash
# Generate visualizations for Smartphone Price Prediction Pipeline
...
python3 src/visualization/visualize_results.py

echo ""
echo "Generating interactive dashboard..."
python3 src/visualization/create_interactive_dashboard.py
